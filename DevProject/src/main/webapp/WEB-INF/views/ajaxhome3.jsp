...
<script type="text/javascript">
	//모든 html dom 객체가 준비가 되었다면 이 함수를 시작해줘.
	$(document).ready(function() {
		//putBtn 클릭하면 이 함수를 작동시켜줘 (서버에 데이터를 전송(ajax)하고, 전송성공유무를 리턴받아서 출력한다.
		$("#getBtn").on("click", function() {
			//사용자가 입력한 데이터를 읽어와서 객체를 만들것
			let boardNo = $("#boardNo");
			//사용자가 입력한 값을 가져온다.
			let boardNoVal = boardNo.val();
			//비동기식 방식으로 서버에 전송한다. (4가지 정보를 넘겨줘야된다.)
...
<body>
	...
	<div>
		<button id="getBtn">수정(put Header type)</button>
	</div>
</body>
</html>